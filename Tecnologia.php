...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Tecnologia Compras Mix</title>
            ...
            <th>  
                ...
                <div style="">
                    ...
                    <div class="producto">
                        ...
                        <form>
                            <button id="comprar" name="comprar" class="btn btn-primary" onclick="#" style="margin-left: 200px">Comprar</button>
                        </form>
                    </div>
                </div> 
            </th>
            ...
            <th>  
                <div >
                    ...
                    <div class="producto1" align="center">
                        ...
                        <form>
                            <button id="comprar" name="comprar" class="btn btn-primary" onclick="#" style="margin-left: 200px"
                                    >Comprar</button>
                        </form>
                    </div>
                </div> 
